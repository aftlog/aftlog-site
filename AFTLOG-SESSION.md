...
- **Keystore USB backup STILL PENDING** — `~/Desktop/aftlog-keystore-backup/aftlog-release.keystore` must be copied to a USB/off-machine drive. Password in `pass` (`aftlog/keystore-password`). Do NOT proceed far without this.
