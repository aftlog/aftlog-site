...
- **🔴 OPEN ITEMS (see Session 4 for full log):**
  ...
  4. **Translations (Rule 3 pass at release):** core strings only → **Tranches 1–6a DONE (1.103.5–1.103.10)**: wizards+addBoat (62), calculators (93), boat detail (58), checklists (58), More/Settings (118), dashboard (33) — ~420 keys × 5 locales. **Remaining: Tranche 6b — 14 trip/fuel analytics sheets (~267 label strings, many shared: months, 'Average …', 'Best …', weekday/weekend).** Tracking: `test/translations_test.dart` (no EN fallback).
