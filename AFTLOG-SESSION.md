...
- **Open (parked):** ~~hotspot visual alignment~~ ✅ finished (Louis, 08-15) · deep-screen translations (Rule 3 pass at release) · site rollout (analytics → beta CTA → distribution; Aug 24 gate) · MLD logo spacing done 5j.
