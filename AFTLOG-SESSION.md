...
- **🔴 OPEN ITEMS (see Session 4 for full log):**
  ...
  4. **Translations (Rule 3 pass at release):** core strings only → **Tranches 1–5 DONE (1.103.5–1.103.9)**: wizards+addBoat (62), calculators (93), boat detail (58), checklists (58), **More/Settings (118)** — ~390 keys × 5 locales. Remaining: dashboard + sheets (~60 Text() strings). Tracking: `test/translations_test.dart` (no EN fallback).
